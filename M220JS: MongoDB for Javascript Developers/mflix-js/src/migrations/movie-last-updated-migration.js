...
const MongoError = require("mongodb").MongoError
  ...
  ; (async () => {
    try {
      ...
      // TODO: Create the proper predicate and projection                     -----------------------------------------------> OK
      ...
      console.log("\x1b[32m",`Found ${moviesToMigrate.length} documents to update`,)

      // TODO: Complete the BulkWrite statement below                     -----------------------------------------------> OK
      const { modifiedCount } = await mflix
        .collection("movies")
        .bulkWrite(moviesToMigrate, { ordered: true, w: 'majority' })
